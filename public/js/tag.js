!function(n) {
    ...
    2: function(n, t, e) {
        ...
        var i = function() {
            ...
            return function(t, e) {
                var r = e || document;
                return "undefined" === typeof n && (n = new BrightTag.HTTP.URL(r.location.href)),
                n.param(t)
            }
        }();
        function o(n, t) {
        ...
        var m = u(Array.prototype.filter, (function(n, t) {
            var e = Array.isArray(this) ? this.slice() : Array.from(this)
              , r = [];
        ...
        var x = {
          ...
          , O = {
            integer: function(n) {
                return Math.floor(Math.random() * (n || 1e8))
            }
        };
        function j(n, t, e) {
        ...
        var _ = {
            pushImage: function(n) {
                throw (new Image).src = n,
                "CookieSync.pushImage no longer supported [" + n + "]"
            },
        ...
        function E(n) {
            ...
            t.alwaysAppendParams = function(n) {
                return w.each(n, t.alwaysAppendParam),
                this
            }
            ,
            t.appendPartialQueryString = function(n) {
                return n && t.alwaysAppendParams(o(n)),
                this
            }
            ,
            ...
            function c(t, e, r) {
                if (t) {
                    var c = r || {}
                      , s = [t + "=" + i(e || "")];
                    !function(n, t) {
                        (t || 0 === t) && (f.isNumber(t) && (t = new Date(t).toUTCString()),
                        n.push("expires=" + t))
                    }(s, c.expires),
                    a(s, "path", c.path),
                    a(s, "domain", c.domain),
                    u(s, "Secure", c.secure),
                    u(s, "HttpOnly", c.httponly),
                    function(t) {
                        if (!(t.length < 4096))
                            throw {
        ...
        function R(n) {
            ...
            s && e.appendParam("inspect-session", s),
            u !== i && e.appendParam("parentReferrer", i),
            d(/^btps\..+/, new N(n.document)),
            d(/^btpdb\..+/, n.store),
            e.appendData = function(n) {
                var t = o(n)
                  , i = function(n) {
            ...
            e.cf = function(n) {
                f.isArray(n) || (n = [n]);
                var t = e.param("cf");
                return t && (n = new Array(t).concat(n)),
                e.replaceParam("cf", n.join()),
                e
            }
            ,
            e.addCf = function(n, t) {
                if (!l(t, g("conditional fire", t)))
                    return !1;
                var r = e.param("cf");
                return e.replaceParam("cf", r ? r + "," + n : n),
                !0
            }
            ,
            e.length = function() {
        ...
        function A(n, t) {
            return new function(n, t) {
                ...
                function u(n) {
                    ...
                    o = "var $ = BrightTag.$; ",
                    BrightTag.jQuery ? t() : i.script(BrightTag.instance.baseUri() + "jquery.js").wait(t)
                }
        ...
        var I = function() {
            ...
            return function(o, a) {
                ...
                this["block:start"] = function() {
                    !function(o) {
                        e.push([t, o.write, o.writeln, o.open, o.close]),
                        t = [],
                        i(o, "write", r),
                        i(o, "writeln", r),
                        i(o, "open", n),
        ...
        function M(n, t) {
            var e = this
              ...
              , o = n.document || {}
              , a = n.window || {}
              , u = n.blab || BrightTag.Blab
              , c = n.errorManager
              , s = n.store
              , d = k(o)
              , p = n.asyncTagManager || C(u, o, d, "domready")
              , g = A(window, "jquery");
            function h(n) {
            ...
            function b(n) {
                e.writeScript = n ? h : v,
                e.appendContent = n ? m : y
            }
            function S() {
                return w.contains(n.mode, "sync")
            }
            function T(t) {
                c.hasErrors() && (t.appendParam("errors", c.toJSON()),
                t.tooLong() && (t.deleteParam("errors"),
                c.tooManyErrors(),
                t.appendParam("errors", c.toJSON()))),
                c.reset({
                    site: n.site,
                    referrer: n.referrer || o.location.href
                })
            }
            e.referrer = n.referrer,
            e.parentReferrer = n.parentReferrer,
            e.docReferrer = n.docReferrer,
            e.site = n.site,
            e.host = n.host,
            e.loadOnly = !!n.loadOnly,
            c && u.addGlobalListener(new J(c)),
            u.run("serializer"),
            e.load = function() {
            ...
            e.primary = function() {
                function n() {
                    var n = e.serverURL();
                    return c && (c.processStoredErrors(),
                    T(n)),
                    n.toString()
                }
                var t = [];
                a.JSON ? t.push(n()) : (t.push(e.baseUri() + "json2.js"),
                t.push((function() {
                    e.writeScript(n())
                }
                ))),
            ...
            e.secondary = function(n) {
                var t = e.serverURL()
                  , r = t.toString();
                n(t),
                t.toString() != r && (t.appendParam("mode", "v1"),
                c && T(t),
                t.isTooLarge() ? e.post(t) : e.writeScript(t.toString()))
            }
            ,
            e.post = function(n) {
        ...
        function D(n) {
            ...
            if (r) {
                ...
                e = r.innerHTML,
                0 !== (e = w.trim(e)).length && w.extend(n, l("(\n" + e + "\n)", (function(n) {
            ...
            if (null != n.site) {
                ...
                try {
                    t = new M(n,r),
                    BrightTag.Events.onDOMReady(t.domReady),
                    t.loadOnly || t.primary()
                } catch (o) {
        ...
        function Q(n, t) {
            ...
            function c(n, t, e) {
                ...
                r.hasConditions() && (r.appendParam("mode", "v1"),
                BrightTag.Blab.script(r.asString()))
            }
            function s(n, t, e) {
                var o = {}
                  , u = []
                    ...
                    w.each(u, (function(o) {
                        ...
                        try {
                            ...
                            c || (c = f[o.dbe] = function(t, e) {
                                ...
                                return i.functionWithAccess(["eventObject", "eventData"], "return " + t + ";" + r)
                            }(o.dbe, u)),
                            e.data(u, c.call(t.target, t, r))
                        } catch (l) {
                            !function(n, t, e, r) {
                                a({
                                    type: n,
            ...
            function g(n) {
                var t, e, r = {}, o = {}, a = [], c = [], s = [];
                function p() {
                    var n, e, r = (n = "post-event conditional fire",
                    e = t,
                    function(t) {
                ...
                return r.execute = function(t, a) {
                    return w.extend(o, a || {}),
                    f.isFunction(t) ? e = t : f.isString(t) ? e = function(t) {
                        try {
                            var e = d("events/" + n + "-tag-" + (o.tagId || "adhoc"));
                            return i.functionWithAccess(["eventObject", "eventData"], t + e)
                        } catch (r) {
                            u("evparse", r.toString(), o.tagId, {
                                eventName: n
                            })
                        }
                    }(t) : window.bt_log("when.execute: unknown action: " + t),
                    r
                }
                ,
            ...
            return e.executeActions = c,
            e.Binder = s,
            e.bind = function(n, t, e, r) {
        ...
        function H(n, t, e) {
            ...
            function c(n) {
                ...
                n.hasOwnProperty("timestamp") && (u = n.timestamp,
                o = !0),
                n.hasOwnProperty("site") && (r = n.site),
                n.hasOwnProperty("referrer") && (i = n.referrer)
            }
            function s(e) {
                e && c(e),
                a = [],
            ...
            function l(e) {
                a.push(function(n) {
                    ...
                    return t.type = t.type || "unknown",
                    t.message = t.message || n.toString(),
                    t.timestamp = u,
                    t
                }(e)),
                n.set(t, d())
            ...
            return e && c(e),
            {
                    ...
                    !function(n) {
                        if (n)
                            try {
                                ...
                                r = t.site,
                                i = t.referrer,
                                f.isArray(t.errors) && (a = a.concat(t.errors))
                            } catch (e) {
                ...
                push: function(n) {
                    if (window.bt_log("error: " + JSON.stringify(n)),
                    o && n && !(n.tagId < -1 || n.pageId < -1))
                        try {
                            l(n)
                        } catch (t) {
        ...
        function U(n) {
            ...
            return t.set = function(n, t, r) {
                ...
                0 === i.expires && (i.expires = +new Date("1/1/2038")),
                e(n, t, i)
            }
            ,
        ...
        function $(n, t) {
            ...
            e.get = function(e) {
                var r = n.get(e);
                return r === undefined && (r = t.get(e)) !== undefined && n.set(e, r),
                r
            }
            ,
            e.remove = function(e) {
        ...
        function G(n) {
            ...
            function S(t, e) {
                var r = n.createElement(t.tagName)
                  , i = w.extend(w.extend({}, t.defaults), e || {});
            ...
            function O(t, e, r) {
                var i = !1
                  , o = S(y, r);
                o.onerror = function() {
                    d("block:error", g("script", "Problem loading " + t)),
                    i || h()
                }
                ,
        ...
        function q(n) {
            ...
            e[void 0].neverQueue(),
            t.addGlobalListener = function(n) {
                r.push(n),
                w.each(e, (function(t, e) {
                    e.applyListener(n)
                }
        ...
        function K(n) {
            ...
            return t = {
                ...
                appendData: function(e) {
                    var i, o = n.data(e);
                    return r["_cb_bt_data('" + e + "')"] = f.isArray(i = o) || f.isObject(i) ? JSON.stringify(o) : o,
                    t
                },
                appendJs: function(n) {
                    return r["_cb_" + n] = l(n),
        ...
        function nn(n) {
            var t = {}
              , e = ["eventObject", "eventData", "$", "bt_data"];
            function r(n, t) {
                n.type = "evdbe",
                i.emit("error", n, t)
            }
            ...
            var e = {}
              , r = {
                tag: function(i, o) {
                    return function(t, r) {
                        var i = t && t.group;
                        r(n.group(i).options(t || {})),
                        i && e[i] === undefined && (e[i] = !0,
                        n.run(i))
                    }(o, (function(n) {
                        n.wait((function() {
                            t.process(n, i)
        ...
        function fn(n, t, e, r, i, o) {
            ...
            function l(n) {
                ...
                }).appendParam("mode", "v2").alwaysAppendParams(n)
                  , e = dn.get("X-BT-InspectSession");
                return e && t.appendParam("inspect-session", e),
                i.findEach(new RegExp("^btp(s|db)\\." + a.site + "\\..+"), (function(n, e) {
                    t.appendParam(n, e)
                }
                )),
                t.appendParams({
                    errors: r.hasErrors() ? r.toJSON() : null
                })
            }
            function p(n) {
                var e = function(n) {
                ...
                e ? (d(n),
                e.tooLong() ? f.ensure("jQuery", (function() {
                    !function(n) {
            ...
            var g = w.extend({
                ...
                store: function(n) {
                    w.each(n, (function(n) {
                        n.name && function(n) {
                            ...
                            delete t.name,
                            delete t.value,
                            i.set(n.name, n.value, t)
                        }(n)
                    }
                    ))
                },
                tag: function(n, e) {
                    return g.emit("tag", n, e),
                    t.tag(n, e)
                },
                script: t.script,
                wait: t.wait,
                events: {
                    bind: function(n, t, r, i) {
                        return g.emit("event-binding", n, t, r, i),
                        e.bind(n, t, r, i)
                    },
                    on: e.handle
                },
                ...
                domready: function(n) {
                    null == n ? (s = !0,
                    t.async(),
                    a.mode = w.filter(a.mode, (function(n) {
                        return "sync" !== n
                    }
                    ))) : c.once("domready", n),
                    s && c.emit("domready", g)
            ...
            if (t && !cn[t]) {
                var e = X(n.data)
                  ...
                  , o = function(n, t, e) {
                    ...
                    return w.contains(e.mode, "sync") && r.sync(),
                    r
                }(r, i, n)
                  , a = Z(e, function(n) {
                  ...
                  , u = H(un ? $(un, dn) : dn, "__bterr_" + t, {
                    site: t,
                    referrer: n.referrer,
                    enabled: !1
                })
                  , c = J(u);
                return e.on("error", c.dbe),
                a.on("error", c.events),
                r.addGlobalListener(c),
                BrightTag.Events.onDOMReady((function() {
                ...
                toJSON: function() {
                    return w.extend(function() {
                        var e = new P(n.src)
                          ...
                          , i = e.fragment()
                          , o = T(e.host);
                        r.staticHost = e.host + e.pathname,
                        o && (r.host = o);
                        ...
                        a.referrer === undefined && t.location.href !== undefined && (r.referrer = t.location.href.split("#")[0]),
                        r
                    }(), function() {
        ...
        function yn(n, t, e) {
            try {
                ...
                if (!BrightTag.instance || BrightTag.instance.site !== r.site) {
                    ...
                    return !r.site || BrightTag.instance || mn(r) ? o && (o.config.mode = (u = o.config.mode,
                    w.contains(u, "v2") ? u : u ? ["v2"].concat(u) : "v2")) : (i = function(n, t) {
                        var e = BrightTag.defaultConfig();
                        return BrightTag.EventBinding = Q(e.window, e.errorManager),
                        BrightTag.instance = new M(w.extend(e, n),t),
                        BrightTag.instance
                    }(r, n.script),
                    o.config.loadOnly = !0),
                    e && e(o, i),
        ...
        function Sn(n, t) {
            t && function(n) {
                BrightTag.Events.onDOMReady(n.domReady),
                n.loadOnly || n.primary()
            }(t),
            n && function(n) {
        ...
        function On(n, t) {
            var e = this
              ...
              , i = "DOMContentLoaded"
              , o = r ? "addEventListener" : "attachEvent"
              , a = r ? "removeEventListener" : "detachEvent"
              , u = r ? "" : "on"
              , c = t.documentElement.doScroll || function() {
                throw "No doScroll"
            }
            ;
            function f() {}
            ...
            e.onDOMReady = function(e) {
                l() ? e.call(this) : t.addEventListener ? (s(t, i, e),
                s(t, i, (function() {
                    d(n, "load", e)
                }
                )),
            ...
            e.enablePageReadyOverrides = function() {
                e.enablePageReadyOverrides = f,
                l() ? g() : (r && s(t, i, p),
                s(n, "load", g))
            }
        }
        window._bt_url_prefix = undefined,
        window._bt_referrer = undefined,
        window._bt_site = undefined,
        window._bt_mode = undefined,
        window.bt_log = a,
        window.bt_eval = r,
        window.bt_parameter = i,
        window.bt_meta = function(n, t) {
        ...
        ,
        window.bt_data = o,
        window.bt_handle_exception = a,
        window.bt_data_escaped = o,
        window.BrightTag = function(n) {
            if (n)
                return n;
            return (n = {}).Escaper = x,
            n.Random = O,
            ...
            n.Main = D,
            n.CookieSync = _,
            n.EventBindingManager = Q,
            n.defaultConfig = function() {
                var n, t = U(document), e = t, r = t;
                try {
                    window.localStorage && window.sessionStorage && ((n = F(sessionStorage, localStorage)).purge(),
                    e = $(t, n),
                    r = $(n, t))
                } catch (jn) {
                    a("Unable to access DOM storage: " + jn)
            ...
            n.Blab = new q(document),
            n.Events = new On(window,document),
            n.Events.enablePageReadyOverrides(),
            n.Content = new Tn(n.Blab),
            n.V2_RESPONSE = !0,
            n.site = gn,
            n.configureNewSites = wn,
            n.configureSite = bn,
            n.configuredSites = pn,
            n.initializeSite = Sn,
            n
        }(window.BrightTag),
        window.btServe = function(n) {
            var t = BrightTag
              , e = {
            ...
            null != window._bt_url_prefix && (e.host = window._bt_url_prefix),
            t.configureSite(t.extend(e, n), window, t.initializeSite)
        }
        ,
        (sn = BrightTag).configureNewSites(window, sn.initializeSite),
        null == sn.instance && setTimeout((function() {
