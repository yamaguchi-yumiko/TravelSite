...
class CreateReservesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('reserves', function (Blueprint $table) {
            ...
            $table->integer('payment')->length(1)->nullable(false)->comment('支払方法');
            $table->integer('transportation')->length(1)->nullable(false)->comment('交通手段');
            ...
            $table->integer('status')->length(1)->nullable(false)->comment('ステータス');
